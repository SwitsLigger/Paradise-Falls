...
local function toggleSeatbelt()
    ...
    Debug('Seatbelt', 'Toggled seatbelt', SeatbeltOn)
    SeatBeltLoop()
    ...
    if SeatbeltOn then
        Notification(i18n.t('seatbelt.on'), i18n.t('seatbelt.title'))
    else
        Notification(i18n.t('seatbelt.off'), i18n.t('seatbelt.title'))
    end
    SendReactMessage('toggle_seatbelt', {
        visible = SeatbeltOn
    })
end
...
RegisterNetEvent('interface:vehicleEntered', function()
    local ped = PlayerPedId()
